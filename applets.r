...
# (α = 4, β = 1), hist(rgamma(100000,shape = 4,scale = 1),breaks = 100,main = expression(paste("Gamma Distribution ",alpha,"=",4," ",beta,"=",1)))
#(α = 40, β = 1), hist(rgamma(100000,shape = 40,scale = 1),breaks = 100,main = expression(paste("Gamma Distribution ",alpha,"=",4," ",beta,"=",1)))
#(α = 80, β = 1). hist(rgamma(100000,shape = 80,scale = 1),breaks = 100,main = expression(paste("Gamma Distribution ",alpha,"=",4," ",beta,"=",1)))
